...
class CapabilityFlagConst
{
	...
	const CLIENT_SECURE_CONNECTION	= (1 << 15); // 32768
	const CLIENT_MULTI_STATEMENTS 	= (1 << 16); // 65536
	const CLIENT_MULTI_RESULTS  	= (1 << 17); // 131072
	const CLIENT_PS_MULTI_RESULTS 	= (1 << 18); // 262144
	const CLIENT_PLUGIN_AUTH  		= (1 << 19); // 524288
	const CLIENT_CONNECT_ATTRS		= (1 << 20); // 1048576
	const CLIENT_PLUGIN_AUTH_LENENC_CLIENT_DATA = (1 << 21); // 2097152
	const CLIENT_CAN_HANDLE_EXPIRED_PASSWORDS 	= (1 << 22); // 4194304
	const CLIENT_SESSION_TRACK 					= (1 << 23); // 8388608
	const CLIENT_DEPRECATE_EOF					= (1 << 24); // 16777216
	const CLIENT_SSL_VERIFY_SERVER_CERT 		= (1 << 30); // 1073741824
	const CLIENT_REMEMBER_OPTIONS				= (1 << 31); // 2147483648
}
